...
try: 
    ...
    import uuid
     ...
     print("Als u voor de eerste keer begint maakt een virtuele omgeving.\n"
           "Daarvoor opent u eerst een terminal en voor u de code in met een pad naar keuze \n"
           "python -m venv /PAD/NAAR/NIEUWE/VIRTUELE/OMGEVING \n"
           "Als de python bibliotheken niet geimporteerd kunnen worden open dan de terminal/command prompt en kopieer onderstaande code \n" 
...
def optie12(): 
    ...
    while True:
        ...
        if input_status in {'v', 'd'}:
            ...
            print("Fout: Het ingevoerde status is een getal. Voer 'v' in voor voorlopig of 'd' voor definitief.")
        else:
            print("Fout: Ongeldige invoer. Voer 'v' in voor voltooid of 'd' voor definitief.")
